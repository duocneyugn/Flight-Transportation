...
--
-- Table structure for table `planemanufacturer`
--
...
--
-- Dumping data for table `planemanufacturer`
--

INSERT INTO `planemanufacturer` (`modelNumber`, `companyName`) VALUES
...
--
-- Indexes for table `planemanufacturer`
--
ALTER TABLE `planemanufacturer`
...
--
-- Constraints for table `planemanufacturer`
--
ALTER TABLE `planemanufacturer`
  ADD CONSTRAINT `planemanufacturer_ibfk_1` FOREIGN KEY (`modelNumber`) REFERENCES `airplane` (`modelNumber`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `planemanufacturer_ibfk_2` FOREIGN KEY (`companyName`) REFERENCES `company` (`name`) ON DELETE CASCADE ON UPDATE CASCADE;
